    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-950 text-white p-6">
      <div className="max-w-md w-full backdrop-blur-md bg-slate-900/80 rounded-3xl p-10 shadow-2xl border border-slate-800 text-center transform transition-all hover:scale-[1.02]">
        ...
        <p className="text-slate-400 mb-10 text-lg leading-relaxed">
          Test your eagle eye. Watch the pitch, see the call on the field, and decide if it should be challenged!
        </p>
        <button 
          onClick={onStart}
          className="w-full py-4 text-xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-500 hover:to-blue-700 rounded-2xl shadow-lg shadow-blue-900/50 transition-all active:scale-95 text-white border border-blue-500/30"
        >
          Play Mode
        </button>
      </div>
